...
$result = get_CURL('https://api.smartfarmingunpad.com/dataset/611f7d7f4750382956b468e4/device');
$getDataseAPI = 'https://api.smartfarmingunpad.com/dataset';
$getResult = get_CURL($getDataseAPI);
$getDatasetId = $getResult[1]['_id'];
?>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link active" href="smoisture.php">Soil Moisture</a>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Berikut merupakan tabel dari Soil Moisture. Untuk melihat data grafik dari setiap sensor klik detail</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
