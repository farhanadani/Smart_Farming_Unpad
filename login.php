        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST" role="form">
                    ...
                    <div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Password Harus Benar">
                    ...
                    if (isset($_POST['login'])) {
                        $API = curl_init();
                        curl_setopt($API, CURLOPT_URL, 'https://api.smartfarmingunpad.com/user/login');
                        curl_setopt($API, CURLOPT_POST, 1);
                        curl_setopt($API, CURLOPT_POSTFIELDS, "email=$_POST[email]&password=$_POST[password]");
                    ...
                    <div class="container-login100-form-btn">
                        <button class="login100-form-btn" style=" background-color: #64BB75;" type="submit" value="login" name="login">
                            Login
                        </button>
                    </div>
                ...
                <div class="login100-more" style="background-image: url('images/gambar_5.png');">
                </div>
            </div>
        </div>
    </div>
