...
$result = get_CURL('https://api.smartfarmingunpad.com/dataset/61305378590b802f53935e9a/device');
$getDataseAPI = 'https://api.smartfarmingunpad.com/dataset';
$getResult = get_CURL($getDataseAPI);
$getDatasetId = $getResult[3]['_id'];
?>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link active" href="at.php">Air Temperature (PPKI)</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Air Temperature</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Berikut merupakan tabel dari Air Temperature. Untuk melihat data grafik dari setiap sensor klik detail</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
