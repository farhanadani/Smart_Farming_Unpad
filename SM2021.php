...
$result = get_CURL('https://api.smartfarmingunpad.com/dataset/6129bfebdb963d1d1eaac307/device');
$getDataseAPI = 'https://api.smartfarmingunpad.com/dataset';
$getResult = get_CURL($getDataseAPI);
$getDatasetId = $getResult[0]['_id'];
?>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link active" href="SM2021.php">Soil Moisture (PPKI)</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Soil Moisture (PPKI)</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Berikut merupakan tabel dari Soil Moisture (PPKI). Untuk melihat data grafik dari setiap sensor klik detail</li>
                    </ol>
                    <!-- <?php var_dump($getResult); ?> -->
                    <div class="card mb-4">
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center><?php setlocale(LC_ALL, 'IND');
                                                    ...
                                                    echo strftime("%Y-%m-%d. %A. %X %p", strtotime($getLU)); ?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
