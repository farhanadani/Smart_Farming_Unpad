...
class Client
{
    ...
    //koding buat localhost

    public function __construct($uri = 'mongodb://localhost:27017/', array $uriOptions = [], array $driverOptions = [])

    //koding buat koneksi yang lain

    //  public function __construct($uri = 'mongodb://smartfarmingunpad:smartfarmingunpad1199@smartfarmingunpad.com:27017/?authSource=admin&readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false', array $uriOptions = [], array $driverOptions = [])
